...
//
///////////////////////////////////////////////////////////////
void CPerfStatPlayerPacketUsageImpl::OutputTimeSpanBlock(CPerfStatResult* pResult, const CTimeSpanBlock& TimeSpanBlock, int iTopPos, int flags,
                                                         const SString& BlockName, bool bDetail)
{
